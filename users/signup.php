   ...
   <div style="text-align:center;margin-top:40px;">
    ...
    <form method="post" action="" id="registrationForm" onsubmit="return checkpass();">
        ...
        <div id="page2" style="display: none;">
            ...
            <i class="fa fa-eye-slash" id="togglePassword" style="position: absolute; right: 10px; top: 15px; cursor: pointer; color: black;"></i>
        </div>
        <div class="form-group field space">
            ...
            <i class="fa fa-eye-slash" id="toggleRepeatPassword" style="position: absolute; right: 10px; top: 15px; cursor: pointer; color: black;"></i>
        </div>
