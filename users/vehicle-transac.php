...
if (strlen($_SESSION['vpmsuid'] == 0)) {
    ...
    // SQL Query for fetching data from tblqr_login (no join to tblvehicle for OwnerName)
    $query = "
        SELECT 'QR' AS Source, tblqr_login.ID AS qrLoginID, tblqr_login.ParkingSlot, tblqr_login.Name AS OwnerName, 
