...
<head>
    ...
    <!-- Meta tag to ensure responsive design on mobile -->
...
<script>
    ...
    // Ensure the camera works properly on mobile and desktop
    Instascan.Camera.getCameras().then(function (cameras) {
        if (cameras.length > 0) {
            let selectedCamera = cameras[0]; // Default: front camera

            // Check if the back camera is available on mobile devices and use it if available
            if (cameras.length > 1) {
